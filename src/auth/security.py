...
from src.utils.common import human_delay, human_click

ACCOUNTS_FILE = Path(os.getenv("CHECKVISA_ACCOUNTS_FILE", Path(__file__).parent.parent.parent / "accounts.json"))
